...
//var ddconfig = ${dingConfig};
 ...
 <z:resource items="jquery,sunzmobile,dingtalk"></z:resource>
...
dingConfig={};
dingConfig.loginSuccess = function(e){
	alert(JSON.stringify(e));
	location.href = href;
	
}
dingConfig.loginError = function(e){
	alert(JSON.stringify(e));
	DingTalk.synicUser(userId,function(){
	alert("成功")
	},function(e){
		alert(JSON.stringify(e));
	})
