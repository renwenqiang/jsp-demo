...
//					.child(tb.x_buttons.upload.buttonSelector).dom[tb.x_buttons.upload.tooltipType] = this.i18n.upload_btn_start_tip;
	...
	onCloseButtonClick : function() {
		...
		for(var i=0;i<store.getCount();i++){
			...
			if(record.data.state==Ext.ux.UploadDialog.FileRecord.STATE_FINISHED){//
...
p.i18n = {
	  ...
	  upload_btn_stop_text: '停上',
	  upload_btn_stop_tip: '停止上传。',
	  close_btn_text: '关闭',
	  close_btn_tip: '关闭上传文件对话框',
	  progress_waiting_text: '等待...',
	  progress_uploading_text: '上传中: 总共{1}个文件，完成{0}几个文件。',
	  ...
	  note_queued_to_upload: '传输队列中',
	  note_processing: '正在上传中...',
	  note_upload_failed: '服务不可用，或网络服务器出现故障。',
