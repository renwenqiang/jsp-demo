...
<head>
    ...
    <script>
        $(function(){
            ...
            clip.setText("cmsController.do?goPage&page=article&articleid=${id}");
            $("#menuLink").val("cmsController.do?goPage&page=article&articleid=${id}");
            clip.glue('copyBtn');
...
<body>
    <div>
        <input id='menuLink'  type='text' style="width:580px;" disabled="disabled"/>
    </div>
    <div class="ui_buttons" style="padding-left: 440px;">
