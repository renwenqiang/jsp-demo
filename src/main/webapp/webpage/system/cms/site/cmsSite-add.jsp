	...
	<div class="media_edit_area" id="js_appmsg_editor">	
		<div class="appmsg_editor" style="margin-top: 0px;">
	 		<div class="inner" style="width:90%">
				<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cmsSiteController.do?doAdd" tiptype="1">
					...
					<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
						...
						<tr>
							...
							<td class="value">
								<t:dictSelect field="siteTemplateStyle"  dictTable="cms_style" dictField="id" dictText="template_name" defaultVal="${cmsSitePage.siteTemsplateStyle}" ></t:dictSelect>
								<span class="Validform_checktip"></span>
