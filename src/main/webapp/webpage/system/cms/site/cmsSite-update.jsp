	...
	<script type="text/javascript" src="plug-in/cms/js/jquery.iframe-transport.js"></script>
  	<script type="text/javascript">
		...
		$(function () {
		    ...
		    //编辑时初始化图片预览
		    var name = "${cmsSitePage.siteName}", imageHref = "${cmsSitePage.siteLogo}";
		    if(name != ""){
		        $("#imageTitle").html(name);
		    }
		    if(imageHref != ""){
		        $("#imageShow").html('<img src="${cmsSitePage.siteLogo}" width="100%" height="160" />');
		    }
		});
	...
	<div class="media_edit_area" id="js_appmsg_editor">	
		<div class="appmsg_editor" style="margin-top: 0px;">
	 		<div class="inner" style="width:90%">
				<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="cmsSiteController.do?doUpdate" tiptype="1">
					<input id="id" name="id" type="hidden" value="${cmsSitePage.id }">
					<input id="createName" name="createName" type="hidden" value="${cmsSitePage.createName }">
					<input id="createDate" name="createDate" type="hidden" value="${cmsSitePage.createDate }">
					<input id="updateName" name="updateName" type="hidden" value="${cmsSitePage.updateName }">
					<input id="updateDate" name="updateDate" type="hidden" value="${cmsSitePage.updateDate }">
					<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
						<tr>
							...
							<td class="value">
								<input id="siteName" name="siteName" value="${cmsSitePage.siteName}"  type="text" style="width: 300px" class="inputxt"  >
						...
						<tr>
							...
							<td class="value">
								<input id="companyTel" name="companyTel" type="text" value="${cmsSitePage.companyTel}" style="width: 300px" class="inputxt" >
								<span class="Validform_checktip"></span>
						...
						<tr>
							<td align="right">
								<label class="Validform_label">站点logo:</label>
							</td>
							<td class="value">
								...
								<input id="siteLogo" name="siteLogo" type="hidden" value="${cmsSitePage.siteLogo}" style="width: 150px" class="inputxt">
						...
						<tr>
							<td align="right">
								<label class="Validform_label">站点模板样式:</label>
							</td>
							<td class="value">
								<t:dictSelect field="siteTemplateStyle"  dictTable="cms_style" dictField="id"   dictText="template_name" defaultVal="${cmsSitePage.siteTemplateStyle}"></t:dictSelect>
								<span class="Validform_checktip"></span>
...
<script src = "webpage/cms/site/cmsSite.js"></script>		