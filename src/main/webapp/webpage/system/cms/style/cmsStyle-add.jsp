	...
	<script type="text/javascript">
		//编写自定义JS代码
		 $(function () {
		    ...
		    //编辑时初始化图片预览
		    var name = "${cmsSitePage.templateName}", imageHref = "${cmsSitePage.reviewImgUrl}";
		    if(name != ""){
		        $("#imageTitle").html(name);
		    }
		    if(imageHref != ""){
		        $("#imageShow").html('<img src="${cmsSitePage.reviewImgUrl}" width="100%" height="160" />');
		    }
		});
	...
	<div class="media_edit_area" id="js_appmsg_editor">	
		<div class="appmsg_editor" style="margin-top: 0px;">
			<div class="inner" style="width:90%">
				<t:formvalid formid="formobj" dialog="true" usePlugin="password" callback="@Override uploadFile" layout="table" action="cmsStyleController.do?doAdd" tiptype="1" >
					...
					<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
						...
						<tr>
							...
							<td class="value">
								<input id="templateUrl" name="templateUrl" type="text" value="${cmsSitePage.templateUrl}"  style="width: 300px" class="inputxt" >
								<br />参考风格：car/baoma/
								<span class="Validform_checktip"></span>
