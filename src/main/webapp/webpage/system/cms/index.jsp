...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="plug-in/cms/cms/css/iscroll.css">
		...
		<script src="plug-in/cms/cms/js/h.js" type="text/javascript"></script>
		<script src="plug-in/cms/cms/js/iscroll.js" type="text/javascript"></script>
        <script type="text/javascript">
            var myScroll;
            function loaded() {
