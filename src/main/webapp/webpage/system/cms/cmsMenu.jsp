...
<head>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("#cmsMenuTree").combotree('setValue','${columnPage.parent.id}');
			//清除combotree选择
		 		...
		 		<div class="inner">
					...
					<table cellpadding="0" cellspacing="1" class="formtable">
						<tr>
							...
							<td class="value">
								<input id="cmsMenuTree" value="${columnPage.parent.name}">
								<input id="parentId" name="parent.id" style="display: none;" value="${columnPage.parent.id}">
						...
						<tr>
							...
							<td class="value">
								<t:dictSelect field="type" typeGroupCode="cms_menu" hasLabel="false" defaultVal="${columnPage.type}" id="type"></t:dictSelect>
								<span class="Validform_checktip"></span>
						...
						<tr id="trLink">
							...
							<td class="value">
								<input class="inputxt" id="href" name="href" style="width: 300px" value="${columnPage.href}"/>
								<span class="Validform_checktip"></span>
