...
<t:datagrid title="log.manage" name="logList"
	...
	sortName="operatetime" sortOrder="desc" pageSize="10">
	<t:dgCol title="log.level" field="operatetype" hidden="true"></t:dgCol>
...
<div id="logListtb" style="padding: 3px; height: 25px">
	...
	<div name="searchColums" style="float: right; padding-right: 15px;">
		日志类型：<select name="operatetype" id="operatetype"
			...
			title="操作时间 "><t:mutiLang langKey="operate.time" />: </span> <input
			type="text" name="operatetime_begin" id="operatetime_begin"
			style="width: 100px; height: 24px;" class="Wdate"
			...
			style="width: 100px; height: 24px; margin-right: 20px;" class="Wdate"
