	...
	public StringBuffer end() {
		...
		if (isfinder) {
			sb.append("filebrowserBrowseUrl:"
					+ Config.get("filebrowserBrowseUrl") + ",");
			sb.append("filebrowserImageBrowseUrl:"
					+ Config.get("filebrowserImageBrowseUrl") + ",");
			sb.append("filebrowserFlashBrowseUrl:"
					+ Config.get("filebrowserFlashBrowseUrl") + ",");
			sb.append("filebrowserUploadUrl:"
					+ Config.get("filebrowserUploadUrl") + ",");
			sb.append("filebrowserImageUploadUrl:"
					+ Config.get("filebrowserImageUploadUrl") + ",");
			sb.append("filebrowserFlashUploadUrl:"
					+ Config.get("filebrowserFlashUploadUrl") + "");
		}
