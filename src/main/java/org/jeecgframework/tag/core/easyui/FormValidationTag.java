	...
	public int doEndTag() throws JspException {
		try {
			...
			if (StringUtil.isEmpty(lang)) {
				lang = "zh-cn";
				((HttpServletRequest) this.pageContext.getRequest()).getSession().setAttribute("lang", lang);
			}
...
//			}
			...
			//	update-end--Author:longjb  Date:20150323 for：修改增加css主题类属性
			sb.append(StringUtil.replaceAll("<script type=\"text/javascript\" src=\"plug-in/Validform/js/Validform_v5.3.1_min_{0}.js\"></script>", "{0}", lang));
			sb.append(StringUtil.replaceAll("<script type=\"text/javascript\" src=\"plug-in/Validform/js/Validform_Datatype_{0}.js\"></script>", "{0}", lang));
			sb.append(StringUtil.replaceAll("<script type=\"text/javascript\" src=\"plug-in/Validform/js/datatype_{0}.js\"></script>", "{0}", lang));
