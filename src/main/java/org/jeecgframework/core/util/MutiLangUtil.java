...
public class MutiLangUtil {
	...
	public void setMutiLangService(MutiLangServiceI mutiLangService) {
		MutiLangUtil.mutiLangService = mutiLangService;
	}
    @Autowired
	public void setCommonService(CommonService commonService) {
		MutiLangUtil.commonService = commonService;
	}
	...
	{
		List<MutiLangEntity> langKeyList = commonService.findByProperty(MutiLangEntity.class, "langKey", lang_key);
	...
	public static boolean existLangKey(String lang_key,String langCode)
	{
		...
		List<MutiLangEntity> langKeyList = commonService.findByQueryString(hql);
		if(!langKeyList.isEmpty())
		{
			return true;
		}
	...
	{
		List<MutiLangEntity> langContextList = commonService.findByProperty(MutiLangEntity.class, "langContext", lang_context);
