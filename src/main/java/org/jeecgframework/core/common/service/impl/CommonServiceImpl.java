...
public class CommonServiceImpl implements CommonService {
	...
	public Object uploadFile(Object o,String op){
		return this.commonDao.uploadFile(o, op);
	}
	
	
	//三正科技修改增加 by xiaojun 2016/09/28
	/**
	 * 调用存储过程无返回值
	 */
	public void executeProcedureNoResult(String executeSql,Object... params) {
		this.commonDao.executeProcedureNoResult(executeSql, params);
	}
}
