...
public class SystemServiceImpl extends CommonServiceImpl implements SystemService {
	...
	public void addLog(String logcontent, Short operatetype, Short loglevel) {
		...
		log.setNote(getIp(request)/*oConvertUtils.getIp() 傻X，记录服务器IP有什么用*/);
...
//        update-end--Author:zhangguoming  Date:20140901 for：修改编码长度的定义
	...
	public void addDataLog(String tableName, String dataId, String dataContent) {
		...
		Long integer = commonDao.getCountForJdbcParam("select max(versionNumber) from TSDatalogEntity where tableName =? and dataid=?",new Object[] {tableName,dataId});
		if (integer != null) {
